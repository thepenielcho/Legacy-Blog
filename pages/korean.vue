<template>
  <div class="max-w-4xl mx-auto">
    <div class="px-5">
        <div class="pt-12 pb-4 text-xl md:text-2xl text-gray-700 font-semibold">한글 | Korean</div>
        <div class="text-gray-500 font-normal text-sm md:text-base">한글로 작성된 글 모음입니다. 영어로 작성된 글들과 번역 관계에 있지는 않습니다.</div>
    </div>
