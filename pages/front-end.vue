<template>
  <div class="max-w-4xl mx-auto">
    <div class="px-5">
        <div class="pt-12 pb-4 text-xl md:text-2xl text-gray-700 font-semibold">웹 개발 | Front-End</div>
        <div class="text-gray-500 font-normal text-sm md:text-base">웹 개발 관련 글 모음입니다.</div>
    </div>
