                ...
                <ul class="flex space-x-1 text-base items-center">
                    <li>
                        <div class="py-1 px-2 rounded-lg hover:bg-gray-100">
                            <nuxt-link :to="{path: '/korean'}" replace class="text-gray-700 text-sm">한글</nuxt-link>
                        </div>
                    </li>
                    <!-- <li class="text-gray-700 mx-auto">|</li> -->
                    <li>
                        <div class="py-1 px-2 rounded-lg hover:bg-gray-100">
                            <nuxt-link :to="{path: '/english'}" replace class="text-gray-700 text-sm">ENG</nuxt-link>
                        </div>
                    </li>
                    <li>
                        <div class="hidden md:block group pl-4">
